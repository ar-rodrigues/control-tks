...
import { fetchDealers, fetchClientes, fetchEstados, fetchZonas } from '../api/dealers/dealers';
                    ...
                    <PrimeReactProvider>
                        <Box p={4}>
                            <Heading as="h1" size="xl" mb={4}>
                                <TableDealers data={data} clientes={clientes} zonas={zonas} estados={estados} isLoading={isLoading} />
                            </Heading>
                        </Box>
                    </PrimeReactProvider>
                )
